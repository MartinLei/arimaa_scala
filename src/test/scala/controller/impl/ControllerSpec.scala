...
class ControllerSpec extends FlatSpec with Matchers {
  ...
  it should "pull a other player tile, if it surround by player stronger tile" in {
    ...
    controller.moveTile(new Position(5, 2), new Position(5, 3)) should
      be(List(new MoveMessage(new Position(5, 2), new Position(5, 3))))
    controller.moveTile(new Position(5, 3), new Position(5, 4)) should
      be(List(new MoveMessage(new Position(5, 3), new Position(5, 4))))

    controller.changePlayer()

    controller.moveTile(new Position(5, 7), new Position(5, 6)) should
      be(List(new MoveMessage(new Position(5, 7), new Position(5, 6))))
    controller.moveTile(new Position(5, 6), new Position(5, 5)) should
      be(List(new MoveMessage(new Position(5, 6), new Position(5, 5))))
    ...
    controller.moveTile(new Position(5, 5), new Position(6, 5)) should
      be(List(new PullMessage(new Position(5, 5), new Position(6, 5))))

    controller.getTileName(PlayerNameEnum.GOLD, new Position(5, 4)) should be(TileNameEnum.ELEPHANT)
    controller.getTileName(PlayerNameEnum.SILVER, new Position(5, 5)) should be(TileNameEnum.NONE)
    controller.getTileName(PlayerNameEnum.SILVER, new Position(5, 6)) should be(TileNameEnum.CAMEL)
  }
