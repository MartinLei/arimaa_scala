...
class RuleBookSpec extends FlatSpec with Matchers {
  ...
  "isTileTrapped" should "give TileTrappedMessage, if the tail is trapped" in {
    ...
    ruleBook.isTileTrapped(PlayerNameEnum.GOLD, new Position(3, 2), new Position(3, 3)) should
  ...
  it should "be null if pos is not a trap position" in {
    ...
    ruleBook.isTileTrapped(PlayerNameEnum.GOLD, new Position(2, 2), new Position(2, 3)) should
      be(Option(null))
  }
